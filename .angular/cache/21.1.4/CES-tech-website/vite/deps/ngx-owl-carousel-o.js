import {
  ...
  NavigationEnd,
  Router
} from "./chunk-VDRFLTSP.js";
import "./chunk-OUSO66EU.js";
import "./chunk-N4MKYZYH.js";
import {
  CommonModule,
  LocationStrategy,
  NgClass,
  ...
  NgTemplateOutlet,
  isPlatformBrowser
} from "./chunk-46VHM5ZW.js";
import "./chunk-MAXULBIL.js";
import {
  Attribute,
...
var CarouselSlideDirective = class _CarouselSlideDirective {
   ...
   */
  dataMerge = input(1, __spreadProps(__spreadValues({}, ngDevMode ? {
    debugName: "dataMerge"
  } : {}), {
    transform: (data) => {
      return +data || 1;
...
var CarouselComponent = class _CarouselComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    viewQuery: function CarouselComponent_Query(rf, ctx) {
      if (rf & 1) {
        ɵɵviewQuerySignal(ctx.dots, _c3, 5)(ctx.navButtons, _c4, 5);
      }
      if (rf & 2) {
        ɵɵqueryAdvance(2);
      }
